...
<body>
    <div class="controller">
        ...
        <div class="block w30 fl">
            <div class="shipin_div">
                <div class="shipin_title">各变电站视频接入</div>
                <div class="shipin_body">

                    <div class="search_box">
                        <input type="text" class="sp_text"/>
                        <input type="button" class="sp_btn"/>
                    </div>

                    <ul>
                        <li>
                            <div>
                                <p class="sp_content"><img src="img/img2.png"</p>
                                <h2 class="sp_tit">宁海变电站</h2>
                            </div>
                        </li>
                        <li>
                            <div>
    ...
    <script>
        ...
        $(".sp_btn").css('margin-top',height*0.017);
